...
import numpy as np
from src.utils.graph.pyrwr.utils import iterator
from src.utils.graph.pyrwr.pyrwr import PyRWR
...
class PPR(PyRWR):
    ...
    def compute(self, seeds, c=0.15, epsilon=1e-9, max_iters=100, handles_deadend=True):
        ...
        r, residuals = iterator.iterate(self.nAT, q, c, epsilon, max_iters, handles_deadend)
